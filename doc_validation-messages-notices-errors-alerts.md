...
for the analytics environment variable, we take something from ruby and insert it into a js variable
...
the ones generated by rails are in **wrapper**
...
flash a message saying **Your item was removed from the Community.**
when a user performs that action
